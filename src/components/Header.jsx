export default function Header({ user, onLoginClick, onLogoutClick, onListItem, onProfileClick }) {
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/80 backdrop-blur-lg">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        {/* Logo and Title */}
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-emerald-500 to-teal-600 text-5xl font-bold text-white shadow-emerald-500/25">
            E
          </div>
          <div>
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <button
            onClick={onListItem}
            className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-emerald-600/20 transition hover:bg-emerald-700 active:scale-[0.98]"
          >
