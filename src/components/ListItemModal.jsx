      ...
      <div className="relative w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
        <div className="mb-6 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">{editItem ? "Update Listing" : "List a new item"}</h2>
              <p className="mt-1 text-sm text-slate-500">Share tools with fellow students on campus.</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-700">Item Images (Min 1 required)</label>
          ...
          <div className="rounded-xl border border-slate-100 bg-slate-50 p-4">
            ...
            <div className="space-y-3">
              ...
              <input name="contactEmail" type="email" value={form.contactEmail} onChange={handleChange} required placeholder="you@student.ruh.ac.lk" className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10" />
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" className="flex-1 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md transition hover:bg-emerald-700">
